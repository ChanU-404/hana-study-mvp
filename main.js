...
function renderLogin() {
  return `
    <div style="padding: 40px 20px; display:flex; flex-direction:column; align-items:center; height:100%; background:#fff;">
      <h1 style="font-size:32px; font-weight:lighter; letter-spacing:1px; margin-top:40px; margin-bottom:40px; color:#222;">HANA DROP</h1>
...
function renderStory() {
  ...
  const storyData = [
    ...
    },
    {
      ...
      text: '하루의 노력,<br>한 번의 도전,<br>포기하지 않는 마음 하나가<br>모두 드롭이 되어 차곡차곡 쌓이고,<br>그 드롭들이 모여<br>다시 행복의 샘을 채워가게 되는 거야.'
    }
  ];
